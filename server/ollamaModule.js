...
export async function runOllama(prompt, context, timeout = config.llm.timeout) {
  ...
  `You are an assistant for PhD students in the Human-Computer Interaction Institute at Carnegie Mellon University. \n
   ...
   If they ask you about something spesific, answer it directly from the context given. You do not need to add extra information or ellaborate on the context. Just make sure whatever is in the context is presented in your response in a human language. 
   User Query: ${prompt}\n
   Context: ${context}\n
